...
public class Node
{
    ...
    public void setIndexSort(int index) {
    ...
    public void drawNode(Graphics g, int node_diam)
    {
        ...
        if(number < 10)
            ...
            g.drawString(((Integer)number).toString(), coordX+7, coordY+20);
        g.setFont(new Font("Arial", Font.BOLD, 10));
        g.setColor(Color.RED);
        g.drawString(((Integer)indexSort).toString(), coordX+22, coordY+20); // indexul in sortarea topologica
    }
}